...
// Create a new header section (thead) for the table
const headerSection: HTMLTableSectionElement = document.createElement("thead");

// Create a new body section (tbody) for the table
const bodyRows: HTMLTableSectionElement = document.createElement("tbody");
...
studentsList.forEach((student) => {
  ...
  const row: HTMLTableRowElement = bodyRows.insertRow();
